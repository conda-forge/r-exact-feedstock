...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-exact-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10244&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-exact-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-exact` can be installed with:

```
conda install r-exact
```

It is possible to list all of the versions of `r-exact` available on your platform with:
